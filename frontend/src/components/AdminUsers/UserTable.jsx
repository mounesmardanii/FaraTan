...
function UserTable({
  ...
  const ctOptions = (courseTypes || []).map((ct) => {
    const sessionsForCT = (formData?.courseType === ct ? sessionOptions : [])
      .map(o => o?.value)
      .filter(Boolean);

    let label = ct;
    if (sessionsForCT.length) {
      label = `${ct} — ${sessionsForCT.join('، ')} جلسه`;
    }
    return { value: ct, label };
  });
  ...
  return (
    <div className="w-full bg-[#D1E7D8] rounded-2xl p-4 overflow-visible">
          ...
          <tbody>
              ...
              return (
                <tr key={u.id} className="bg-[#eaf4ef] border-b border-[#D1E7D8] hover:bg-[#f4fdf8] transition">
                  <td className="py-3 px-4">
                    <img src={u.avatar || assets.woman4} alt="avatar" className="w-9 h-9 rounded-full mx-auto border-2 border-white shadow-md" />
                  </td>
                    ...
                    <>
                      ...
                      <td className="py-3 px-4">
                        <input 
                          ...
                          onChange={(e) => setFormData({ ...formData, sportGoal: e.target.value })}
                          className="w-full px-3 py-1 border rounded text-xs" 
                          placeholder="هدف ورزش" 
                        />
                      </td>
                      <td className="py-3 px-4">
                        <select
                      ...
                      <td className="py-3 px-4">
                        ...
                        >
                          <option value="" disabled>انتخاب تعداد جلسات</option>
                      ...
                      <td className="py-3 px-4">
                        <div className="flex gap-2 justify-center">
                          ...
                          <button 
                            onClick={resetForm} 
                            className="bg-gray-300 text-gray-700 px-3 py-1 rounded-lg hover:bg-gray-400 cursor-pointer"
                          >
                            لغو
                          </button>
                        </div>
                      ...
                      <td className="py-3 px-4">
                        <div className="flex gap-2 justify-center">
                          ...
                          <button 
                            ...
                            className="bg-red-100 text-[#FF6347] px-3 py-1 rounded-lg hover:bg-red-200 cursor-pointer"
                          >
                            حذف
                          </button>
                        </div>
            ...
            {addingNew && (
              <tr className="bg-white border-t border-[#ccc]">
                <td>
                  <img src={formData.avatar || assets.woman4} alt="avatar" className="w-9 h-9 rounded-full mx-auto border shadow" />
                </td>
                <td>
                  <input 
                    value={formData.name || ''} 
            ...
            <button
              onClick={() => {
                setFormData((f) => ({
                  ...
                  courseType: f.courseType || courseTypes[0] || 'عمومی',
                  sessionCount: '',
      ...
      <div className="md:hidden flex flex-col gap-4">
        {addingNew && (
          <div className="bg-[#f1f8f4] rounded-xl p-4 shadow text-xs text-[#055B5C] space-y-2">
            <div className="flex items-center gap-2">
              <img src={formData.avatar || assets.woman4} alt="avatar" className="w-10 h-10 rounded-full border" />
          ...
          editIndex === u.id ? (
            ...
            <div key={u.id} className="bg-[#eaf4ef] rounded-xl p-4 shadow text-xs text-[#055B5C]">
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-2">
                  <img src={u.avatar || assets.woman4} alt="avatar" className="w-10 h-10 rounded-full border" />
                ...
                <div className="flex gap-1">
                  ...
                  <button 
                    onClick={() => handleDeleteUser(u.id)} 
                    className="bg-red-100 text-[#FF6347] px-2 py-1 rounded hover:bg-red-200"
                  >
                    حذف
                  </button>
                </div>
