...
from  app.domain.schemas.member_schema import (MemberCreateSchema, MemberResponseSchema,
                                                ...
                                                BodyMeasurementCreateSchema, BodyMeasurementUpdateSchema, UpdateMemberInfoSchema
)
...
class MemberService(BaseService):
    ...
    async def create_profile(self, member_id: UUID, profile_data: MemberProfileCreateSchema) -> MemberProfile:
        ...
        profile = MemberProfile(
            ...
            age = self._calculate_years_between(profile_data.birthdate),
    ...
    async def update_profile(
        ...
        profile = self.get_profile_by_member_id(member_id)
        if not profile:
        ...
        if update_data.birthdate:
            age = self._calculate_years_between(update_data.birthdate)    
