...
function VipCoursePage() {
    ...
    useEffect(() => {
        const data = JSON.parse(localStorage.getItem("vipCourses")) || [];
        setRows(data);
    ...
    const handleAddRow = () => {
        ...
        setRows(updatedRows);
        localStorage.setItem("vipCourses", JSON.stringify(updatedRows));
    ...
    const handleDelete = (id) => {
        ...
        setRows(updated);
        localStorage.setItem("vipCourses", JSON.stringify(updated));
    };
    ...
    const handleSaveEdit = () => {
        setEditingId(null);
        localStorage.setItem("vipCourses", JSON.stringify(rows));
    };
    ...
    return (
        <div className="min-h-screen bg-white font-sans flex flex-col relative p-4 md:p-15">
            <main
                ...
                bg-white text-right p-4 md:p-6 relative min-h-screen flex flex-col"
            >
                <button
                    onClick={() => navigate(-1)}
