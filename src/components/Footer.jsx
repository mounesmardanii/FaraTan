...
function Footer() {
    ...
    return (
        <footer id='footer' className="bg-[#EDEDED] text-right px-6 md:px-12 py-12 mt-20">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-10">
                ...
                >
                    ...
                    <p className="text-[#055B5C] text-[15px] md:text-[17px] leading-relaxed mb-4 max-w-md">
                        همراه حرفه‌ای تو برای ساختن زندگی سالم‌تر 💪<br />
                    ...
                    <motion.a
                        ...
                        className="w-10 h-10 flex items-center justify-center mx-auto rounded-full border border-[#055B5C] shadow-sm text-[#FF6600] hover:bg-[#055B5C] hover:text-white transition"
                    >
                ...
                <div className="w-full md:w-2/3 flex flex-col sm:flex-row justify-between gap-6 mt-10 md:mt-0">
                    ...
                    <motion.div
                        className="bg-[#EDEDED] rounded-xl px-4 py-5 w-full sm:w-1/2 text-center"
                    ...
                    >
                        ...
                        <ul className="space-y-2 text-[#055B5C] text-[15px] md:text-[16px] font-medium mt-3">
                            {[
                                { label: 'برنامه کلاس‌ها', link: '#classes' },
                                { label: 'ثبت‌نام و ورود', link: '#auth' },
