      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="w-full md:w-1/3 flex justify-center md:justify-end">
          <button 
            ...
            className="bg-[#055B5C] text-white text-sm md:text-base font-bold px-8 md:px-12 py-2 md:py-3 rounded-full transition-all duration-300 cursor-pointer hover:bg-[#044A4B] hover:scale-105 text-center"
          >
