  ...
  return (
    ...
    >
      ...
      <table className="w-full table-fixed border-collapse">
        <thead className="text-[#FF6600] text-sm">
          <tr>
            <th className="p-2 text-center border-b border-[#B5D2C1]">خرید</th>
            <th className="p-2 text-center border-b border-[#B5D2C1]">وضعیت</th>
            <th className="p-2 text-center border-b border-[#B5D2C1]">مربی</th>
            <th className="p-2 text-center border-b border-[#B5D2C1]">قیمت</th>
            <th className="p-2 text-center border-b border-[#B5D2C1]">سطح</th>
        ...
        <tbody className="text-sm">
          {classList.map((item, index) => (
            ...
            >
              ...
              <td className="p-2 text-center">{item.coach}</td>
