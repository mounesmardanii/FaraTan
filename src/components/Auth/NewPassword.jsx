        ...
        >
          ...
          <div className="w-full max-w-6xl z-10 md:flex items-center gap-10">
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="w-full md:w-1/2 bg-[#055B5C] rounded-[2rem] p-4 sm:p-6 md:p-10 text-white flex flex-col justify-center shadow-2xl"
            >
              <motion.h2
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2, duration: 0.5 }}
                className="text-lg sm:text-xl md:text-2xl font-bold text-[#FF6600] mb-3 sm:mb-4 text-center md:text-right leading-snug"
              >
                تنظیم رمز عبور جدید
              </motion.h2>
              ...
              <motion.p
                ...
                className="text-xs sm:text-sm md:text-base text-center md:text-right mb-4 sm:mb-6 leading-relaxed"
              >
